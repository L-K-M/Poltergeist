...
/// to choose (the selection's label, the accent's), and the preset tests
/// use it to hold every shipped theme to the thresholds the rest of the app
/// already meets. A translucent colour has no contrast of its own:
