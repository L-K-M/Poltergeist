...
// Ported from Séance
// app/seance_app/lib/ui/editor_syntax.dart @ 2e6d1f1 — tokenizer,
// controller, and engine semantics verbatim; divergences per
...
/// Token colors plus search-hit colors, per brightness. The values are
/// Poltergeist's own, tuned to the 02 §11 teal seed (0xFF3D8A78) and
/// contrast-checked per D20; the token/search color *slots* are Séance's.
