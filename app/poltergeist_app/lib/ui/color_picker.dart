// Ported from Séance app/seance_app/lib/ui/color_picker.dart @ 8714859; see docs/PORTS.md.
// Divergence: strings localize through ARB (D20), so [showColorPicker]
// takes its title rather than defaulting one, and the hex field uses this
// app's monospace stack.
    ...
    return AlertDialog(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    style: poltergeistMonoTextStyle,
                    decoration: InputDecoration(
                      ...
                      errorText: _hexInvalid
                          ? (_alpha
                                ? l10n.colorPickerHexErrorAlpha
                                : l10n.colorPickerHexError)
                          : null,
            ...
            _ChannelSlider(
              ...
              semanticValue: l10n.colorPickerDegrees(_hsv.hue.round()),
            ...
            _ChannelSlider(
              ...
              semanticValue: l10n.colorPickerPercent(
      ...
      actions: [
        TextButton(
          ...
          child: Text(l10n.colorPickerCancel),
        ),
        FilledButton(
          ...
          child: Text(l10n.colorPickerUse),
        ),
      ],
    );
  }
