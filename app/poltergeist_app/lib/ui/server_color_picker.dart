    ...
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: l10n.serverColorPickerHexLabel,
                      prefixText: '#',
                      counterText: '',
                      errorText:
                          _hexInvalid ? l10n.serverColorPickerHexError : null,
            ...
            _ChannelSlider(
              label: l10n.serverColorPickerHue,
              value: _hsv.hue,
              max: 360,
              colors: [
              ...
              semanticValue:
                  l10n.serverColorPickerDegrees(_hsv.hue.round()),
              onChanged: (hue) => _setHsv(_hsv.withHue(hue)),
            ),
            _ChannelSlider(
              label: l10n.serverColorPickerSaturation,
              ...
              semanticValue: l10n
                  .serverColorPickerPercent((_hsv.saturation * 100).round()),
              onChanged: (s) => _setHsv(_hsv.withSaturation(s)),
            ),
            _ChannelSlider(
              label: l10n.serverColorPickerBrightness,
              value: _hsv.value,
              max: 1,
              colors: [
              ...
              semanticValue: l10n
                  .serverColorPickerPercent((_hsv.value * 100).round()),
              onChanged: (v) => _setHsv(_hsv.withValue(v)),
            ),
            const SizedBox(height: 4),
            Text(
              l10n.serverColorPickerHint,
      ...
      actions: [
        TextButton(
          ...
          child: Text(l10n.serverColorPickerCancel),
        ),
        FilledButton(
          ...
          child: Text(l10n.serverColorPickerUse),
        ),
      ],
    );
  }
