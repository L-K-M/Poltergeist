...
// share. Lives as long as the view: the main window's, whose engine every
// workspace window renders on.
void drag_out_channel_register(FlView* view);

// Serves an extra workspace window's |view| too (00 D39): `startDrag`
// names it by its view id. Does nothing before drag_out_channel_register
// has run on the engine's main view.
