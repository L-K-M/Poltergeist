...
const _allowedTechnicalLiterals = <String, Set<String>>{
  ...
  'lib/services/session_state.dart': {
    ...
    // 00 D37's document of the windows open beside the first: its list
  ...
  'lib/services/session_state_store.dart': {
    "'session.state'",
    // 00 D37: the windows open beside the first, under their own key.
    "'session.windows'",
  },
  // 00 D37's workspace windows: the runner channel's name, the diagnostics
  ...
  // 00 D37's window command ids (D21 plumbing), never rendered.
