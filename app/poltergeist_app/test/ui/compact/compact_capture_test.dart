...
/// light and dark: Home, a local and a remote browser, selection mode,
...
void main() {
  for (final brightness in Brightness.values) {
    ...
    testWidgets('captures the compact posture ($tone)', (tester) async {
      ...
      // Real elevation: the test binding otherwise paints every shadow as
      // a solid outline, which a capture must not show.
      debugDisableShadows = !_captureOn;
      try {
        await _runScenes(tester, tone, brightness);
      } finally {
