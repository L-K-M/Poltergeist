// The sync command registrations (M8, 05 §9 / 02 §8.3/§9): ids,
// ⌥⌘Y / Ctrl+Alt+Y activators, Commands-menu ordering, enabled
// predicates, and run delegation.
@TestOn('vm')
library;
...
void main() {
  testWidgets('registers the two 05 §9 verbs with their §8.3 chords',
      (tester) async {
    ...
    // New Saved Sync carries no chord — menu/palette only.
