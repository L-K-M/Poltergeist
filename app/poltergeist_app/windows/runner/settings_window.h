// Ported from Séance app/seance_app/windows/runner/settings_window.h @ 38b7a42; see docs/PORTS.md.
...
// "poltergeist/settings_link" is forwarded to the other engine, and its reply
