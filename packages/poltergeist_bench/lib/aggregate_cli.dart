...
/// Aggregate CLI body, exposed as a library entrypoint so the relocated
/// package and the legacy `tool/bench` compatibility entrypoint run
/// identical code.
Future<void> aggregateMain(List<String> arguments) async {
