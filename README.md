...
**Current version:** v<!-- version -->0.1.0<!-- /version --> · [v0.1.0 pre-release published](https://github.com/L-K-M/Poltergeist/releases/tag/v0.1.0) — M0 and M1 are complete; M2 (connection layer) is in progress.
