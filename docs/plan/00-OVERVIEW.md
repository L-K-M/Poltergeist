...
- **D13 — Single window in v1.** One window, dual pane, tabs per pane; a
  ...
  is parked in D25. *Superseded by D39 (2026-09-25): the desktops open
...
- **D36 — Settings in its own window (2026-09-25, owner-directed;
  ...
  - **Still parked (D25):** more than one workspace window. D13's single
    workspace window stands. *D39 lifted this the same day.*
...
- **D39 — More than one workspace window (2026-09-25, owner-directed;
...
- **D25 — v2-and-beyond parking lot** (recorded so nobody "helpfully"
  ...
  multi-window (landed as D39); Custom Tools (user scripts); content search on remotes;
