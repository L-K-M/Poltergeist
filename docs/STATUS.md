...
main (`2f99f4e`, post PR-S3); M1 remains open pending the v0.1.0 publish and
close sweep (open item 1), and M2 has started: the initial pooled
`ConnectionManager` is in; open items 4–7 track remaining slices, audit
gaps, and decisions._
